...
namespace ExcelizeCs
{
    public static class Lib
    {
        ...
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern TypesC.IntErrorResult GetColStyle(
            long fileIdx,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string sheet,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string col
        );
        ...
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern TypesC.StringErrorResult GetDefaultFont(long fileIdx);
        ...
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr SetDefaultFont(
            long fileIdx,
    ...
    public class File
    {
        ...
        /// <param name="sheet">The worksheet name</param>
        /// <param name="col">The column name</param>
        /// <returns>Return the column style ID if no error occurred,
        /// otherwise raise a RuntimeError with the message.</returns>
        /// <exception cref="RuntimeError">Return None if no error occurred,
        /// otherwise raise a RuntimeError with the message.</exception>
        public unsafe int GetColStyle(string sheet, string col)
        {
            TypesC.IntErrorResult res = Lib.GetColStyle(FileIdx, sheet, col);
            string err = new(res.err);
            if (!string.IsNullOrEmpty(err))
                throw new RuntimeError(err);
            return res.val;
        ...
        /// </summary>
        /// <returns>Return the default font name if no error occurred,
        /// otherwise raise a RuntimeError with the message.</returns>
        /// <exception cref="RuntimeError">Return None if no error occurred,
        /// otherwise raise a RuntimeError with the message.</exception>
        public unsafe string GetDefaultFont()
        {
            TypesC.StringErrorResult res = Lib.GetDefaultFont(FileIdx);
            string err = new(res.err);
            if (!string.IsNullOrEmpty(err))
                throw new RuntimeError(err);
            return new(res.val);
        ...
        /// <summary>
        /// SetDefaultFont changes the default font in the workbook. The
        /// spreadsheet generated by excelize default font is Calibri.
        /// </summary>
        ...
        {
            string err = Marshal.PtrToStringUTF8(Lib.SetDefaultFont(FileIdx, fontName));
            if (!string.IsNullOrEmpty(err))
                throw new RuntimeError(err);
        }
